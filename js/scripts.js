...
const set_name = (type) => {
  ...
  if (type === "first_name") {
    ...
    if (!first_name) {
      ...
      document.getElementById("first_name_error").style.visibility = "initial";
    }
    // Иначе
    else {
      // Изменяем цвет кнопки на зеленый и текст - на белый.
      document.getElementById("first_name_button").style.backgroundColor =
        "green";
  ...
  // Если проверяем поле второго игрока
    ...
    if (!second_name) {
      // Делаем поле ошибки видимым. Оно уже хранит текст описания ошибки.
      document.getElementById("second_name_error").style.visibility = "initial";
    }
    // Иначе
    else {
      // Изменяем цвет кнопки на зеленый и текст - на белый, как он просил.
      document.getElementById("second_name_button").style.backgroundColor =
        "green";
      ...
      document.getElementById("second_name_error").style.visibility = "hidden";
    }
  }
...
const check_city = () => {
  ...
  if (!check_value) {
    ...
    error_field.style.visibility = "initial";
  }
  // Иначе
  else {
    /*
